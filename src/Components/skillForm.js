...
function SkillForm(props) {
  ...
  const newInput = (e) => {
        e.preventDefault()
        setLinkNo(linkNo + 1)
        setArray([...array,<input onChange= {props.handleLinks} class="uk-input" id="form-horizontal-text" type="url"  placeholder="Some text..." name={linkNo.toString()}/>])
    }
...
const renderMonths = () => {
    ...
    <div class="uk-margin ">
        ...
        <div class="uk-form-controls">
            <input onChange ={props.handleChange} name="title" class="uk-input" id="form-horizontal-text" type="text" placeholder="Some text..." required/>
        </div>
    </div>
    ...
    <div class="uk-margin ">
        ...
        <div class="uk-form-controls">
            <input onChange ={props.handleChange} name="description" class="uk-input" id="form-horizontal-text" type="text" placeholder="Some text..."/>
        </div>
    </div>
    ...
    <div class="uk-margin ">
        ...
        <div class="uk-form-controls">
            <input onChange = {props.handleLinks} class="uk-input" id="form-horizontal-text" type="url" size ="5" placeholder="Some text..." name="0"/>
            {array}
